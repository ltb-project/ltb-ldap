...
final class LanguageTest extends \Mockery\Adapter\Phpunit\MockeryTestCase
{
    function test_accept_all_language() {
        ...
        $allLanguages = array("ar, cn, de, el, es, fr, it, nb-NO, pl, pt-PT, ru, sl, tr, zh-CN, ca, cs, ee, en, eu, hu, ja, nl, pt-BR, rs, sk, sv, uk, zh-TW");
        $allowedLanguages = array("en", "fr");
        $defaultLanguage = "en";

        # Execute function
        $chosenLanguage = \Ltb\Language::detect_language($defaultLanguage, $allLanguages);

        $this->assertEquals(implode(",", $allLanguages), $chosenLanguage);
    }
    ...
    function test_restrict_language() {
        ...
        $allLanguages = array("ar, cn, de, el, es, fr, it, nb-NO, pl, pt-PT, ru, sl, tr, zh-CN, ca, cs, ee, en, eu, hu, ja, nl, pt-BR, rs, sk, sv, uk, zh-TW");
        $allowedLanguages = array("fr", "en");
        $defaultLanguage = "fr";

        # Execute function
        $chosenLanguage = \Ltb\Language::detect_language($defaultLanguage, $allowedLanguages ? array_intersect($allLanguages, $allowedLanguages) : $allLanguages);
